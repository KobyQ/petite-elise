...
const ClubAuthorization = ({
  values,
  errors,
  prevStep,
  isSubmitting,
}: ClubAuthorizationProps) => {
    ...
    <div className="my-10">
      ...
      <div className="mt-8 border-b pb-6">
        <p className="mb-6 font-bold text-gray-600 text-lg">
          ...
          By registering your child, you give Petite Elise Preschool and Building Blocks Club the
...
export default ClubAuthorization;
