            ...
            try {
              await fetch("/api/contact", {
                ...
                body: JSON.stringify({
                  ...
                  message: `Registration confirmed for ${registrationData.childName} in Summer Camp Program. Payment reference: ${ref}`,
                }),
              })
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-[#ffec89] to-[#a9e2a0] flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">
          Thank you for registering your child for Summer Camp Program. Your payment has been confirmed.
        </p>
        ...
        {registration && (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 text-left">
            ...
            <div className="space-y-1 text-sm text-blue-700">
              ...
              <p><strong>Program:</strong> Summer Camp Program</p>
