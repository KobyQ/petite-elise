        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8">
          ...
          <div className="text-center">
            <Button
              ...
              className="bg-primary hover:bg-opacity-90 text-white px-8 py-3 text-lg font-semibold"
            >
              {submittingPayment ? (
                ...
                <div className="flex items-center gap-2">
                  ...
                  Pay Now - {formatMoneyToCedis(feeRequest.invoice_amount || 0)}
                </div>
              )}
            </Button>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 text-center">
            <p className="text-gray-600">
              ...
              <a href={`mailto:${process.env.NEXT_PUBLIC_EMAIL || 'info@petiteelise.com'}`} className="text-primary hover:underline">
                {process.env.NEXT_PUBLIC_EMAIL || 'info@petiteelise.com'}
              </a>
            </p>
          </div>
        </div>
