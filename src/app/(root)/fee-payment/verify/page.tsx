...
const VerifyPageContent = () => {
  ...
  const [feeRequest, setFeeRequest] = useState<any>(null)
  ...
  useEffect(() => {
    async function verifyTransaction() {
      try {
        ...
        // Look for school fees payment record
        ...
        if (paymentData) {
          setFeeRequest(paymentData)
          setLoading(false)
        } else {
          // If payment record not found, retry after delay
          setTimeout(() => {
            verifyTransaction()
        ...
        >
          ...
          <div className="space-y-2 md:space-y-4 mb-6 md:mb-8">
            <p className="text-sm md:text-base text-deep-green/80">
              We&apos;re currently processing your payment and updating your fee records.
            </p>
            <p className="text-sm md:text-base text-deep-green/80">
      ...
      <div className="min-h-screen bg-gradient-to-b from-cream to-white flex flex-col items-center justify-center px-4 py-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
            ...
            <Link href="/request-fees" className="flex-1">
    ...
    <div className="min-h-screen bg-gradient-to-r from-[#ffec89] to-[#a9e2a0] flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">
          Thank you for your school fees payment. Your payment has been confirmed successfully.
        </p>
        ...
        {feeRequest && (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 text-left">
            ...
            <div className="space-y-1 text-sm text-blue-700">
              <p><strong>Child:</strong> {feeRequest.child_name}</p>
              <p><strong>Parent:</strong> {feeRequest.parent_name}</p>
              <p><strong>Email:</strong> {feeRequest.email}</p>
              <p><strong>Programs:</strong> {feeRequest.programs.join(", ")}</p>
